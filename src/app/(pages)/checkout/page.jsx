...
//   console.log("Return Cart Data: ",cart);
...
//                         <div>
//                             <Label className="block text-md font-medium mb-2">Payment Method</Label>
//                             <div className="flex items-center gap-2 p-3 rounded-md bg-gray-100 border">
//                                 <input
//                                 type="radio"
//                                 id="payOnDelivery"
//                                 name="paymentMethod"
...
//                                 />
//                                 <Label htmlFor="payOnDelivery" className="text-sm font-medium">
//                                 Pay on Delivery (Cash or Transfer)
//                                 </Label>
//                             </div>
//                             <p className="text-gray-500 text-sm mt-1">You’ll pay when the item is delivered to your address.</p>
//                         </div>

//                         <Button type="submit" className="w-full text-lg py-6" disabled={placeOrderMutation.isLoading}>
...
const CheckoutPage = () => {
    ...
    if (isLoading) { /* ... your loading spinner JSX ... */ }
    
    if (isOrderPlaced) { /* ... your "Thank You" screen JSX ... */ }
