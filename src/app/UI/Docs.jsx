...
const Docs = () => {
  ...
  return (
    <div className="px-16 py-20 max-sm:px-5 bg-blue-200">
      <main className="p-7 bg-white rounded shadow-xl">
        <h1 className="text-2xl py-2 font-semibold text-zinc-800">
          Favorite Plug - Canada's Trusted Tech & Gadget Destination
        </h1>
        <h2 className="text-xl py-1 font-bold text-zinc-600">
          Shop Premium Gadgets & Accessories in One Click
        </h2>
        <p className="text-zinc-600">
          Welcome to Favorite Plug, your go-to online store in Canada for high-quality phones, laptops, smartwatches, accessories, and more...
        </p>

        {/* Conditionally render the rest of the content */}
        {showMore && (
          <>
            <h1 className="text-xl pt-2 pb-1 font-bold text-zinc-600">
            ...
            <ul className="text-zinc-600 list-disc pl-5">
