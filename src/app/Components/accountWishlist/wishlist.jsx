...
export const AccountWishlist = () => {
  ...
  const wishListToken = localStorage.getItem('favoritePlugUser');
  if(!wishListToken){
    <div className="p-5 text-center max-sm:h-[85vh]">
      <h1>Login to add items to your wishlist 💔</h1>
  ...
  return (
    <div>
      <div className="lg:px-20 bg-zinc-50 p-5 max-sm:px-2 mb-[auto-fit] rounded-xl min-h-[85vh] max-h-fit">
